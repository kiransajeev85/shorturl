...
class ShortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create short" do
    assert_difference('Short.count') do
      post shorts_url, params: { short: { long_url: @short.long_url, short_url: @short.short_url } }
    end
  ...
  test "should update short" do
    patch short_url(@short), params: { short: { long_url: @short.long_url, short_url: @short.short_url } }
